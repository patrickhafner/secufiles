 ...
 */
Cache::config('_secufiles_core_', array(
	'engine' => $engine,
	'prefix' => $prefix . '_secufiles_core_',
 ...
 */
Cache::config('_secufiles_model_', array(
	'engine' => $engine,
	'prefix' => $prefix . '_secufiles_model_',
